...
- `lfpl-min/core`: The syntax and semantics of LFPL-Min.
  ...
  - `operational.ist`: Gives a big-step operational semantics for LFPL-Min. The language for values (to which terms are evaluated) include a value of diamond type so that we can reason about the runtime of programs which use nonempty lists. This is necessary since LFPL-Min does not have any closed terms of diamond type.
