...
%
It was first presented in \cite{hofmannLinearTypesNonsizeincreasing1999}, where it is shown that \lfpl is polynomial-time sound. That is, all functions definable in \lfpl belong to FP.
%
The logical inverse of this statement, polynomial-time completeness, is later proven in \cite{hofmannStrengthNonsizeIncreasing2002}.
%
