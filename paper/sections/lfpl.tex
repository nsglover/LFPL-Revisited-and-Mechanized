...
for $\tmrec{M}{N_1}{x_0}{x_1}{x_2}{N_2}$.
\begin{lstlisting}
...
Importantly, both for the general convenience of the programmer and for the very important example following this one, we can inspect whether a list is empty, which is often seen as pattern matching on the list data structure in standard functional programming languages.
\begin{lstlisting}
