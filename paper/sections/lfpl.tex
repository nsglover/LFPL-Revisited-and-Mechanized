...
To build an intuition about the expressivity of \lfpl{}, we implement
a few examples functions that demonstrate how you can program in the
language.

\begin{lstlisting}
lunfold : L(A) -o 1 + A * L(A)
\end{lstlisting}
...
unsusp : (L(1) -o L(A)) -o L(1) -o L(A)
unsusp = lam f . lam m . f m
\end{lstlisting}
\end{example}
